	...
	return (
		<footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
			<div className="m-4 sm:m-6 flex-1">
				<h2 className="text-4xl text-center md:text-left mb-4">RunwayX</h2>
				<p className="text-justify text-gray-700">Welcome to our fashion brand website, where style meets sophistication. Our brand is all about expressing yourself through fashion and feeling confident in what you wear.</p>
				<ul className="flex mt-6 justify-center md:justify-start space-x-4">
					...
					<li>
						<a href="https://github.com/onkarb6101/RunwayX/tree/main/Fashion-Store"><GitHub /></a>
					</li>
				</ul>
			</div>			
			...
			<div className="m-4 sm:m-6">
				...
				<ul className="space-y-3 text-gray-700">
					<li className="flex items-center">
						...
						<span>City Paradise, Kothrud, Pune</span>
					</li>					
					<li className="flex items-center">
					...
					<li className="flex items-center">
						...
						<a href="mailto:onkarb2112@gmail.com" target="_blank">
						onkarb2112@gmail.com
						</a>
					</li>
					{/* <li className="flex items-center">
